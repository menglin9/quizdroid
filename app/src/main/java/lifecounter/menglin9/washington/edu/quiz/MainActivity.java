    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.i("in", "ink");
                if (position == 0) {
                    Intent next = new Intent(MainActivity.this, Math.class);
                    startActivity(next);
                } else if (position == 1) {
                    Intent next = new Intent(MainActivity.this, Physics.class);
                    startActivity(next);
                } else if (position == 2) {
                    Intent next = new Intent(MainActivity.this, Unix.class);
                    startActivity(next);
                }
