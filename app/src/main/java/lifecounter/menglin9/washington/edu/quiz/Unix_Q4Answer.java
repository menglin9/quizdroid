...
public class Unix_Q4Answer extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unix__q4_answer);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next = new Intent(Unix_Q4Answer.this, Unix_Q5.class);
                startActivity(next);
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_unix__q4_answer, menu);
        return true;
    }
