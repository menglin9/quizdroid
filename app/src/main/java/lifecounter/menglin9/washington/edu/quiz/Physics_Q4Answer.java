...
public class Physics_Q4Answer extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.physics__q4_answer);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next = new Intent(Physics_Q4Answer.this, Physics_Q5.class);
                startActivity(next);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_physics__q4_answer, menu);
        return true;
    }
