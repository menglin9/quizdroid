...
public class Unix_Q1Answer extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unix__q1_answer);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent next = new Intent(Unix_Q1Answer.this, Unix_Q2.class);
                startActivity(next);
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_unix__q1_answer, menu);
        return true;
    }
